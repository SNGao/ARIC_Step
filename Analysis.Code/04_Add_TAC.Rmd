...
## Load data
```{r}
dt.step = read_csv('00_Intermediate_output/02_Step_Cov_V9.csv'); dt.step$...1 = NULL
```
...
png('Results/03_Combined(TAC-only).subtitle.png', width = 14, height = 5.5, units = 'in', res = 300)
combined_plot
dev.off()
```
