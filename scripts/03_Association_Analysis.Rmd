...
write.csv(df_wide.P, here('Results/06_Association_results/06_Model_Results/LR.M1.Pvalue.csv'))
write.csv(df_wide.T, here('Results/06_Association_results/06_Model_Results/LR.M1.Tvalue.csv'))

dat_t = read.csv(here('Results/06_Association_results/06_Model_Results/LR.M1.Tvalue.csv')) |> dplyr::select(-X)
# row.names(dat_t) = dat_t$outcome; dat_t$outcome = NULL
dat_p = read.csv(here('Results/06_Association_results/06_Model_Results/LR.M1.Pvalue.csv')) |> dplyr::select(-X)
# row.names(dat_p) = dat_p$outcome; dat_p$outcome = NULL

png(here('Results/06_Association_results/06_LR.M1(HeatMap).png'), height = 4, width = 3, units = 'in', res = 600)
...
write.csv(df_wide.P, here('Results/06_Association_results/06_Model_Results/LR.M2.Pvalue.csv'))
write.csv(df_wide.T, here('Results/06_Association_results/06_Model_Results/LR.M2.Tvalue.csv'))

dat_t = read.csv(here('Results/06_Association_results/06_Model_Results/LR.M2.Tvalue.csv')) |> dplyr::select(-X)
dat_p = read.csv(here('Results/06_Association_results/06_Model_Results/LR.M2.Pvalue.csv')) |> dplyr::select(-X)

png(here('Results/06_Association_results/06_LR.M2(HeatMap).png'), height = 4, width = 3, units = 'in', res = 600)
HeatMap_LR(dat_t, dat_p)
dev.off()
```
...
png(here('Results/06_Association_results/06_LR.M1.Scaled.png'), 
...
png(here('Results/06_Association_results/06_LR.M2.Scaled.png'), 
...
writexl::write_xlsx(output.dt, here('Results/06_LR.M1.Scaled.Coef.xlsx'))
...
writexl::write_xlsx(output.dt, here('Results/06_LR.M2.Scaled.Coef.xlsx'))
```
...
write.csv(df_wide.P, 
          here('Results/06_Association_results/06_Model_Results/Log.M1.Pvalue.csv'))
write.csv(df_wide.T, 
          here('Results/06_Association_results/06_Model_Results/Log.M1.Tvalue.csv'))

dat_t = read.csv(here('Results/06_Association_results/06_Model_Results/Log.M1.Tvalue.csv')) |> 
  dplyr::select(-X)
# row.names(dat_t) = dat_t$outcome; dat_t$outcome = NULL
dat_p = read.csv(here('Results/06_Association_results/06_Model_Results/Log.M1.Pvalue.csv')) |> 
  dplyr::select(-X)
# row.names(dat_p) = dat_p$outcome; dat_p$outcome = NULL

png(here('Results/06_Association_results/06_Log.M1(HeatMap).png'), 
...
write.csv(df_wide.P, 
          here('Results/06_Association_results/06_Model_Results/Log.M2.Pvalue.csv'))
write.csv(df_wide.T, 
          here('Results/06_Association_results/06_Model_Results/Log.M2.Tvalue.csv'))

dat_t = read.csv(here('Results/06_Association_results/06_Model_Results/Log.M2.Tvalue.csv')) |> 
  dplyr::select(-X)
dat_p = read.csv(here('Results/06_Association_results/06_Model_Results/Log.M2.Pvalue.csv')) |> 
  dplyr::select(-X)

png(here('Results/06_Association_results/06_Log.M2(HeatMap).png'), 
    height = 1.8, width = 3.3, units = 'in', res = 600)
HeatMap_LR(dat_t, dat_p)
dev.off()
```
...
png(here('Results/06_Association_results/06_Log.M1.Scaled.png'), 
...
png(here('Results/06_Association_results/06_Log.M2.Scaled.png'), 
    height = 4, width = 4, units = 'in', res = 600)
print(p1)
dev.off()
```
...
writexl::write_xlsx(output.dt, here('Results/06_Log.M1.Scaled.Coef.xlsx'))
...
writexl::write_xlsx(output.dt, here('Results/06_Log.M2.Scaled.Coef.xlsx'))
```
...
png(here('Results/06_Association_results/06_LR.M1.Nonscale.png'),
    height = 8.0, width = 5.0, units = 'in', res = 600)
print(g1)
dev.off()
```
...
png(here('Results/06_Association_results/06_LR.M2.Nonscale.png'), 
    height = 8.0, width = 5.0, units = 'in', res = 600)
print(g1)
dev.off()
```
...
writexl::write_xlsx(output.dt, here('Results/06_LR.M1.NonScale.Coef.xlsx'))
...
writexl::write_xlsx(output.dt, here('Results/06_LR.M2.NonScale.Coef.xlsx'))
```
...
png(here('Results/06_Association_results/06_Log.M1.Nonscale.png'), 
...
png(here('Results/06_Association_results/06_Log.M2.Nonscale.png'), 
    height = 4, width = 4.5, units = 'in', res = 600)
print(p1)
dev.off()
```
...
writexl::write_xlsx(output.dt, here('Results/06_Log.M1.NonScale.Coef.xlsx'))
...
writexl::write_xlsx(output.dt, here('Results/06_Log.M2.NonScale.Coef.xlsx'))
```
...
library(dplyr)
dt.all = read_csv('00_Intermediate_output/03_Step_Cov_Imputed.csv')
dt.all$Hypertension = ifelse(dt.all$Hypertension == 'Yes', 1,0)
dt.all$Diabetes = ifelse(dt.all$Diabetes == 'Yes', 1,0)
```
